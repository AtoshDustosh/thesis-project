 ...
 * Still, there are some situations where the input is invalid. For example, (orignal, inserted, insertPos) = ("0123", "5", 5). This method does not allow 
 * @return char* inserted string
 */
